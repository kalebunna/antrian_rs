            ...
            <div class="card border-start border-3 border-info">
                <div class="card-body">
                    <form action="{{ route('identitas.update', $identitas->id) }}" method="post">
                        @csrf
                        <input type="hidden" name="jenis" value="identitas">
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0">Nama Puskesmas</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" value="{{ $identitas->nama }}" name="nama" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" value="{{ $identitas->alamat }}"
                                    name="alamat" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <textarea type="text" class="form-control" name="deskripsi">{{ $identitas->deskripsi }}
                            </textarea>
                            </div>
                        </div>
                    ...
                    <table class="table-bordered table">
                        <tbody>
                            <tr>
                                <td>Logo Aplikasi</td>
                                <td>
                                    <img src="{{ asset('images/' . $identitas->logo) }}" width="100" alt="">
                                </td>
                            </tr>
                            <tr>
                                <td>Video Profil</td>
                                <td>
                                    <video width="400" controls>
                                        <source src="{{ asset('video/' . $identitas->video) }}" type="video/mp4">
                                    </video>
                                </td>
                            </tr>
                        </tbody>
