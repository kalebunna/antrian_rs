...
<script>
    ...
    async function panggil() {
        ...
        for (const element of dataFromServer) {
            await antrianPanggilan(element.kode, element, );
        }
                ...
                kode_antrian.addEventListener("ended", function() {
                    ...
                    if (parseInt(no) > 20 && parseInt(no) < 100) {
                            ...
                            if (number != 0) {
                                ...
                                menujuKe.addEventListener("ended",
                                    function() {
                                        ...
                                        const det = await waitForAudioEnded(
                                            tujuan);
                                    })
                            }
                        })
                        ...
                        nomer.addEventListener("ended", function() {
                            ...
                            const angka = new Audio(convertAssetWav(puluh));
                            angka.play();
                        ...
                        nomer.addEventListener("ended", function() {
                            ...
                            const menujuKe = new Audio(convertAssetMp3(
                                "segera menuju"));
                            menujuKe.play();
                            menujuKe.addEventListener("ended", function() {
                                menujuKe.pause();
                                const tujuan = new Audio(
                                    convertAssetMp3(
                                        element
                                        .menuju));
                                tujuan.play()
                                const det = await waitForAudioEnded(tujuan);
